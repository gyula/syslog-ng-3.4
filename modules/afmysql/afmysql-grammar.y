...
start
        : LL_CONTEXT_DESTINATION dest_afmysql                        { YYACCEPT; }
        ;
...
dest_afmysql_option
        ...
        | KW_DBD_OPTION '(' string LL_NUMBER ')' { afmysql_dd_add_dbd_option_numeric(last_driver, $3, $4); free($3); }
        | KW_DBD_OPTION '(' string string ')'    { afmysql_dd_add_dbd_option(last_driver, $3, $4); free($3); free($4); }
        ...
        | KW_LOAD '(' string ')'		{ afmysql_dd_load(last_driver, $3); free($3); }
        | KW_BULK '(' string ')'		{ afmysql_dd_bulk(last_driver, $3); free($3); }
