...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     KW_AMQP = 10511,
     KW_EXCHANGE = 10512,
     KW_EXCHANGE_DECLARE = 10513,
     KW_EXCHANGE_TYPE = 10514,
     KW_PERSISTENT = 10515,
     KW_VHOST = 10516,
     KW_ROUTING_KEY = 10517,
     KW_BODY = 10518
   };
#endif
/* Tokens.  */
...
#define KW_AMQP 10511
#define KW_EXCHANGE 10512
#define KW_EXCHANGE_DECLARE 10513
#define KW_EXCHANGE_TYPE 10514
#define KW_PERSISTENT 10515
#define KW_VHOST 10516
#define KW_ROUTING_KEY 10517
#define KW_BODY 10518
