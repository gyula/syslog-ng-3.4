...
static const yytype_int16 yyrhs[] =
{
     ...
     155,   146,    -1,   156,   155,    -1,    -1,    84,   145,   157,
     146,    -1,    44,   145,   158,   146,    -1,    45,   145,   158,
     146,    -1,    46,   145,   158,   146,    -1,    47,   145,   158,
     146,    -1,   162,    -1,   158,   157,    -1,    -1,   125,    -1,
     128,    -1,   160,    -1,   158,   160,    -1,    -1,   103,   145,
     158,   146,    -1,   161,    -1,    35,   145,   159,   146,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   351,   351,   357,   356,   366,   367,   371,   372,   373,
     374,   375,   376,   380,   381,   579,   580,   601,   605,   606,
     643,   655,   656
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_CSV_PARSER", "'('", "')'", "'{'", "'}'", "';'", "':'", "$accept",
  "start", "parser_expr_csv", "$@1", "parser_csv_opts", "parser_csv_opt",
  "parser_csv_flags", "string", "string_list", "string_list_build",
  "parser_opt", "parser_column_opt", 0
};
#endif
...
{
       0,   151,   152,   154,   153,   155,   155,   156,   156,   156,
...
{
       0,     0,     0,     0,     2,     1,     3,     6,     0,     0,
       0,     0,     0,     0,     0,     0,     6,    21,    12,    19,
       0,     0,     0,     0,    14,     0,     4,     5,    15,    16,
      19,     0,    17,     0,     0,     0,     0,     0,    14,     0,
      18,    22,     8,     9,    10,    11,     7,    13,    20
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     4,     7,    15,    16,    37,    30,    31,    32,
      17,    18
};
...
{
       1,  -136,    14,  -130,  -137,  -137,  -137,   -35,  -128,  -127,
    -125,  -124,  -123,  -122,  -121,  -120,   -35,  -137,  -137,  -112,
    -112,  -112,  -112,  -112,  -112,  -112,  -137,  -137,  -137,  -137,
    -112,  -119,  -137,  -118,  -117,  -116,  -115,  -114,  -112,  -113,
...
{
    -137,  -137,  -137,  -137,     9,  -137,    -4,   -19,  -137,     5,
    -137,  -137
};
...
{
      35,    20,    21,    22,    23,    24,    25,     6,   144,    44,
      45,    46,    47,   125,     0,   145,   128,   145,   145,    38,
     145,   145,   145,   145,   145,    16,   146,   146,   146,   146,
     146,   146,   146,   146,    38,    30,    -1,    -1,    -1,    -1,
...
{
       0,     6,   152,   144,   153,     0,   145,   154,    35,    44,
      45,    46,    47,    84,   103,   155,   156,   161,   162,   145,
     145,   145,   145,   145,   145,   145,   146,   155,   125,   128,
     158,   159,   160,   158,   158,   158,   158,   157,   158,   158,
     160,   146,   146,   146,   146,   146,   146,   157,   146
};
