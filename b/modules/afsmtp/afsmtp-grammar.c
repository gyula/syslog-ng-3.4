...
#define yylval          afsmtp_lval
#define yychar          afsmtp_char
#define yydebug         afsmtp_debug
#define yynerrs         afsmtp_nerrs
#define yylloc          afsmtp_lloc

/* Copy the first part of user declarations.  */


/* Line 268 of yacc.c  */
#line 79 "afsmtp-grammar.c"
...
/* Line 343 of yacc.c  */
#line 452 "afsmtp-grammar.c"
/* Unqualified %code blocks.  */

/* Line 344 of yacc.c  */
#line 30 "afsmtp-grammar.y"
...
static const char *const yytname[] =
{
  ...
  "afsmtp_option", "string", "dest_driver_option", 0
};
#endif
...
/* Line 1806 of yacc.c  */
#line 364 "afsmtp-grammar.y"
    { afsmtp_dd_set_host(last_driver, (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 7:

/* Line 1806 of yacc.c  */
#line 365 "afsmtp-grammar.y"
    { afsmtp_dd_set_port(last_driver, (yyvsp[(3) - (4)].num)); }
    break;

  case 8:

/* Line 1806 of yacc.c  */
#line 366 "afsmtp-grammar.y"
    { afsmtp_dd_set_subject(last_driver, (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 9:

/* Line 1806 of yacc.c  */
#line 367 "afsmtp-grammar.y"
    { afsmtp_dd_set_body(last_driver, (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 10:

/* Line 1806 of yacc.c  */
#line 368 "afsmtp-grammar.y"
    {
		afsmtp_dd_add_header(last_driver, (yyvsp[(3) - (5)].cptr), (yyvsp[(4) - (5)].cptr));
...
/* Line 1806 of yacc.c  */
#line 373 "afsmtp-grammar.y"
    { afsmtp_dd_set_from(last_driver, (yyvsp[(3) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 12:

/* Line 1806 of yacc.c  */
#line 374 "afsmtp-grammar.y"
    { afsmtp_dd_set_from(last_driver, (yyvsp[(3) - (5)].cptr), (yyvsp[(4) - (5)].cptr)); free((yyvsp[(3) - (5)].cptr)); free((yyvsp[(4) - (5)].cptr)); }
    break;

  case 13:

/* Line 1806 of yacc.c  */
#line 375 "afsmtp-grammar.y"
    { afsmtp_dd_set_from(last_driver, (yyvsp[(3) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 377 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_TO, (yyvsp[(3) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 16:

/* Line 1806 of yacc.c  */
#line 378 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_TO, (yyvsp[(3) - (5)].cptr), (yyvsp[(4) - (5)].cptr)); free((yyvsp[(3) - (5)].cptr)); free((yyvsp[(4) - (5)].cptr)); }
    break;

  case 17:

/* Line 1806 of yacc.c  */
#line 379 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_CC, (yyvsp[(3) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 18:

/* Line 1806 of yacc.c  */
#line 380 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_CC, (yyvsp[(3) - (5)].cptr), (yyvsp[(4) - (5)].cptr)); free((yyvsp[(3) - (5)].cptr)); free((yyvsp[(4) - (5)].cptr)); }
    break;

  case 19:

/* Line 1806 of yacc.c  */
#line 381 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_BCC, (yyvsp[(3) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 20:

/* Line 1806 of yacc.c  */
#line 382 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_BCC, (yyvsp[(3) - (5)].cptr), (yyvsp[(4) - (5)].cptr)); free((yyvsp[(3) - (5)].cptr)); free((yyvsp[(4) - (5)].cptr)); }
    break;

  case 21:

/* Line 1806 of yacc.c  */
#line 383 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_REPLY_TO, (yyvsp[(3) - (4)].cptr), (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 22:

/* Line 1806 of yacc.c  */
#line 384 "afsmtp-grammar.y"
    { afsmtp_dd_add_rcpt(last_driver, AFSMTP_RCPT_TYPE_REPLY_TO, (yyvsp[(3) - (5)].cptr), (yyvsp[(4) - (5)].cptr)); free((yyvsp[(3) - (5)].cptr)); free((yyvsp[(4) - (5)].cptr)); }
    break;

  case 26:

/* Line 1806 of yacc.c  */
#line 728 "afsmtp-grammar.y"
