...
[ -d "${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.4.2" ] || ./install-sh -d "${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.4.2"
./install-sh -o root -g root -m 0644 ChangeLog \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.4.2/ChangeLog
./install-sh -o root -g root -m 0644 NEWS \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.4.2/NEWS
./install-sh -o root -g root -m 0644 AUTHORS \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.4.2/AUTHORS
./install-sh -o root -g root -m 0644 COPYING \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.4.2/COPYING
...
%{prefix}/bin/loggen
%{_mandir}/*
%docdir %{_prefix}/share/doc/syslog-ng-3.4.2
%{_prefix}/share/doc/syslog-ng-3.4.2/*
...
%changelog
* Mon Sep 14 2009 Balazs Scheidler <bazsi@balabit.com> 3.4.2-1
- Removed some more Premium Edition related cruft.
* Wed Sep 02 2009 Balazs Scheidler <bazsi@balabit.com> 3.4.2-1
- Removed the references to the documentation and libzlicense-devel
* Wed Apr 04 2007 Tamas Pal <folti@balabit.com> 3.4.2-1
